...
exports.ReduxContainer = function (props) {
    ...
    var store = redux_1.createStore(redux_1.combineReducers(reducers), redux_localstorage_simple_1.load() || props.initialState, redux_1.applyMiddleware.apply(void 0, [connected_react_router_1.routerMiddleware(history), redux_thunk_1.default, redux_logger_1.createLogger(), redux_localstorage_simple_1.save()].concat((props.middleware || []))));
